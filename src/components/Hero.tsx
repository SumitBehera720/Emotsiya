...
export const Hero: React.FC<HeroProps> = ({ onOpenPassModal }) => {
  return (
    ...
    >
      ...
      {/* Clean Soft Teal Tinted Overlays on Left Side for Text Readability */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-8 space-y-6 text-left">
            ...
            {/* Top Ticker Pill */}
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/90 border border-teal-100 shadow-sm backdrop-blur-md">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-[#164e63] leading-[1.08] font-serif-heading">
            ...
            {/* Trust Proof Badges */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs font-bold text-slate-700 pt-2">
