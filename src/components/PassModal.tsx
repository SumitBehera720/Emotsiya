...
export const PassModal: React.FC<PassModalProps> = ({ isOpen, initialTier = '199', onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-md">
      <div className="relative max-w-lg w-full rounded-3xl bg-white/95 border border-white p-6 sm:p-8 space-y-6 shadow-2xl overflow-hidden backdrop-blur-2xl">
        ...
        {!isSubmitted ? (
          <>
            <div className="space-y-2 text-center sm:text-left">
              ...
              <h3 className="text-2xl font-black text-slate-900">Get Your Emotsiya Pass</h3>
            ...
            <div className="grid grid-cols-2 gap-3 p-1 rounded-2xl bg-[#faf7f2] border border-slate-200">
              <button
                type="button"
              ...
              >
                <span className="block text-slate-200">Standard Pass</span>
              ...
              <button
                ...
                className={`py-3 px-4 rounded-xl text-xs font-bold transition-all text-center space-y-0.5 relative ${
                  selectedTier === '499'
                    ? 'bg-gradient-to-r from-amber-700 to-amber-950 text-white shadow-md'
                    : 'text-slate-700 hover:text-slate-900'
                }`}
              >
                <span className="block text-amber-200">Premium Leader</span>
                <span className="block text-lg font-black text-amber-300">₹499</span>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-[#faf7f2] border border-slate-200 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-amber-600 font-medium"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3.5 px-4 rounded-xl bg-[#25D366] hover:bg-[#20ba5a] text-white font-extrabold text-xs shadow-md transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="text-center space-y-6 py-4">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-black text-slate-900">Registration Details Saved!</h3>
              <p className="text-xs text-slate-600 max-w-sm mx-auto font-medium">
                Thank you <span className="font-bold text-amber-800">{fullName}</span>! Click below to send your pre-filled pass request directly to our team on WhatsApp.
              </p>
            </div>

            <div className="p-4 rounded-2xl bg-[#faf7f2] border border-slate-200 text-left text-xs text-slate-700 space-y-1 font-mono">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full py-3.5 px-4 rounded-xl bg-[#25D366] hover:bg-[#20ba5a] text-white font-extrabold text-xs shadow-lg transition-all"
            >
