    ...
    <section id="courses" className="py-24 lg:py-32 bg-[#f4fbfb] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <motion.div
          ...
          className="max-w-2xl mx-auto text-center space-y-4 mb-16 sm:mb-20"
        >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2 pt-2">
                    <div className="flex flex-wrap gap-1.5">
                      {course.modules.slice(0, 3).map((module, mIdx) => (
                        <span key={mIdx} className="px-2.5 py-1 rounded-lg bg-teal-50 text-teal-900 text-xs font-semibold flex items-center gap-1 border border-teal-100">
